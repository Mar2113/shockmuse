<footer>
        ...
        <div class="footer-div">
            <p>© 2024 Shockmuse Web. Todos los derechos reservados. <a href="accesibilidad.html" style="color: #fff; text-decoration: underline;" title="Ir a la página de accesibilidad">Accesibilidad</a></p>
        </div>
    </footer>
